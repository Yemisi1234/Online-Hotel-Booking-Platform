const roomDatabase =[  {
       ...
       "description":"Hotel Shiva Sai Lodge is a furnished and modest property located in Regimental Bazaar, Shivaji Nagar, Secunderabad, Telangana."
   
          },
              {
       "name":"OYO Flagship 75243 Metro International",
       "imageurls":[
        "./images/deluxeroom2.jpeg",
    ...
    },
    {
       ...
       "description":"Couples are welcome Guests can check in using any local or outstation ID proof (PAN card not accepted). Only Indian Nationals allowed As a complimentary benefit, your stay is now insured by Acko."
    },
    {
       "name":"Capital O 15959 The City Park",
       "imageurls":[
        "./images/deluxeroom5.jpeg",
       ...
       "description":"Night Curfew in Telangana | Check-in allowed between 05:00 AM to 09:00 PM Couples are welcome Guests can check in using any local or outstation ID proof (PAN card not accepted). As a complimentary benefit, your stay is now insured by Acko."
    }
 ]
